    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/selectfunction">Selectfunction - /selectfunction</Link></li>
<li><Link href="/diseaseoneselecttype">Diseaseoneselecttype - /diseaseoneselecttype</Link></li>
<li><Link href="/fee">Fee - /fee</Link></li>
<li><Link href="/selecttypelist">Selecttypelist - /selecttypelist</Link></li>
          </ul>
