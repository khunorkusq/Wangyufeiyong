...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: 172Yx6cii6FJ/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: F2HOaAmiycqq/icon
...
export const PlasmicAlert__ArgProps = new Array<ArgPropType>("icon", "header");
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fkhPx, {
          [sty.freeBoxnoBody__fkhPXtaQFi]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader__fkhPx6AqCh]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon__fkhPx6Kg2A]: hasVariant(
            $state,
            "noIcon",
            "noIcon"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__aafg, {
            [sty.freeBoxnoIcon__aafg6Kg2A]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__sf6Zz)}
                role={"img"}
              />
            ),
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___9G9LD, {
            [sty.freeBoxnoHeader___9G9LD6AqCh]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon___9G9LD6Kg2A]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
