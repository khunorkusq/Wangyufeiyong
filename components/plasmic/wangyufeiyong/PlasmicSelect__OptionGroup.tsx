...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: CSUX_8mvNst4/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Q1osv0uQLlR_/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__bcPwi)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zAtL)}
              />
            </React.Fragment>
          ),
          value: args.children
